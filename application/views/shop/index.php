<div class="mainbanner">
  <div id="main-banner" class="owl-carousel home-slider">
    ...
    <div> <a href="<?=$slider->link_slider;?>"><img style="width:1903px" src="<?=$slider->img_slider;?>" alt="<?=$slider->title_slider;?>" class="img-responsive" /></a> </div>
  ...
  <div class="container">
    <div class="row">
      <div class="content col-sm-12">
        <div class="customtab">
          <h3 class="productblock-title" style="margin-bottom: 25px">ZZZNewest Product</h3>
...
<!--            <div class="viewmore">-->
<!--              <a href="--><?//=base_url('catalog/?sort=id_product-DESC');?><!--" class="btn">View All <i class="fa fa-angle-double-right"></i></a>-->
<!--            </div>-->
          </div>
        </div>
      </div>
      <div class="content col-sm-12">
        <div class="customtab">
          <h3 class="productblock-title" style="margin-bottom: 25px">Best Selling</h3>
            <span class="viewall"><a href="<?=base_url('catalog/?sort=total_rating-DESC');?>">View All <i class="fa fa-angle-double-right"></i></a></span>
        </div>
        <!-- tab-furniture-->
        <div id="tab-furnitur" class="tab-content">
          <div class="row">
...
<!--            <div class="viewmore">-->
<!--              <a href="--><?//=base_url('catalog/?sort=total_rating-DESC');?><!--" class="btn">View All <i class="fa fa-angle-double-right"></i></a>-->
<!--            </div>-->
          </div>
        </div>
      </div>
