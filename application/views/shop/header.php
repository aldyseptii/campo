...
<link href="<?=base_url("assets/moonstore/ms01");?>/image/icon/favicon.ico" rel="icon" type="image/png" >
  ...
  <div class="container">
    <div class="header-inner">
      <div class="col-sm-3 col-xs-3 header-left">
        <div id="logo"> <a href="<?=base_url();?>"><img src="<?= base_url("assets"); ?>/logo.png" style="max-height:105px" title="<?=$this->shop_setting->sitename();?>" alt="<?=$this->shop_setting->sitename();?>" class="img-responsive" /></a> </div>
      </div>
      <div class="col-sm-9 col-xs-9 header-right">
        <div id="search" class="input-group">
          <form action="<?=base_url('search');?>" method="get">
          <input type="text" name="q" value="<?php if(isset($q)) echo $q;?>" placeholder="Search.." class="form-control input-lg" />
          <span class="input-group-btn">
          <button type="submit" class="btn btn-default btn-lg"><span class="fa fa-search" style="color: gray;"></span></button>
          </span>
          </form>
        </div>
        <div id="cart" class="btn-group btn-block">
          <button type="button" class="btn btn-inverse btn-block btn-lg dropdown-toggle cart-dropdown-button"> <span id="cart-total"><span>Cart</span><br>
        ...
        ?>
            ...
            <li style="text-align: center;margin-bottom: 12px" class="nullcart">Your cart is empty</li>
  ...
  <div class="nav-inner">
    ...
    <div class="navbar-collapse">
      <ul class="main-navigation">
        ...
        <?php } ?>
          <li><a href="<?=base_url('tracking');?>" title="Status Pesanan">Track Order</a></li>
