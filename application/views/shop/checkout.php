...
<div class="breadcrumb parallax-container">
  ...
  <h1 class="text-shadow-shadenco">Checkout</h1>
  <ul>
...
<div class="container">
  <div class="row justify-content-center">
    <div class="col-sm-9" style="float:none;margin:0 auto">
        <h1>Silahkan Lengkapi Data Pembeli:</h1>
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group bg-warning p-3">
                            ...
                            <textarea name="catatan_invoice" class="form-control" placeholder="Silahkan isi details catatan yang ingin disampaikan ke penjual."></textarea>
                        </div>
                </div>
            </div>
            </div>
