                ...
                <div class="col-sm-5">
                    <div class="thumbnails">
                        <div class="left-column" id="ProductPhoto">
                            <a class="thumbnail fancybox" rel="lightbox" href="<?= base_url("img/622x800/$bigthumb"); ?>">
                                <img id="ProductPhotoImg" class="product-zoom tampil" src="<?= base_url("img/622x800/$bigthumb"); ?>"/>
                            </a>
...
<!--                    </div>-->
                        ...
                        <div class="form-group">
                            <div class="qty">
                                ...
                                <ul class="button-group list-btn">
                                    <li>
                                        <button type="button" class="addtocart-btn csrf" data-csrf="<?=$this->security->get_csrf_hash();?>" data-id="<?=$detail->id_product;?>" data-toggle="tooltip" data-placement="top" title="Add to cart"  ><i class="fa fa-shopping-bag mr-2"></i> Add to Cart</button>
                                    </li>
                                </ul>
                            </div>
                        </div>
            ...
            <div class="productinfo-tab">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#tab-review">Comment (<?=count($comments);?>)</a></li>
                </ul>
                        ...
                        <form id="formComment">
                            ...
                            <div class="buttons clearfix">
                                <div class="pull-right">
                                    <button type="button" id="send-comment" data-loading-text="Loading..." class="btn btn-primary">Submit</button>
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            <h3 class="productblock-title">Related Product</h3>
            <h4 class="title-subline">You may also like</h4>
            <div class="box">
